...
public class Magpie4
{
    ...
    public String getResponse(String statement)
    {
        ...
        else
        {
            ...
            else if (position >= 0 && findKeyword(statement, "I want", position) >= 0)
            {
            ...
            position = findKeyword(statement, "you", 0);
    ...
    private String transformIWantStatement(String statement)
    {
        ...
        int positionOfI = findKeyword (statement, "I want", 0);

        String restOfStatement = statement.substring(positionOfI + 6).trim();
    ...
    private String getRandomResponse()
    {
        ...
        String[] randomRArrays = new String[] {"Interesting, tell me more.", "Hmmm.", "Do you really think so?", "You don't say.", "ok.", "Maybe so."};
        int rnd = (int)(Math.random()*randomRArrays.length);
        return randomRArrays[rnd];
    }
